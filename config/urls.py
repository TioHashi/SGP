...
urlpatterns = [
    ...
    path('servidores/<int:pk>/ficha/pdf/', servidor_ficha_pdf, name='servidor_ficha_pdf'),
    ...
    path('notificacoes/<str:codigo>/ler/', notificacao_ler, name='notificacao_ler'),
    path('notificacoes/ler-todas/', notificacao_ler_todas, name='notificacao_ler_todas'),
