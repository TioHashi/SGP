...
from core.models import Escola, FolhaAlteracao, FolhaPdf, Frequencia, PerfilUsuario, Servidor
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        total = 0
        models = [Escola, get_user_model(), PerfilUsuario, Servidor, Frequencia, FolhaPdf, FolhaAlteracao]
        for model in models:
            count = 0
