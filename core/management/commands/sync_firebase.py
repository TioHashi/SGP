...
from core.models import Escola, FolhaAlteracao, FolhaExclusao, FolhaPdf, Frequencia, PerfilUsuario, Servidor
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        total = 0
        models = [Escola, get_user_model(), PerfilUsuario, Servidor, Frequencia, FolhaPdf, FolhaAlteracao, FolhaExclusao]
        for model in models:
            count = 0
